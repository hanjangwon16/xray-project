...
export default function AtlasView(){
 ...
 useEffect(()=>{
  ...
  const down=(e:PointerEvent)=>{element.setPointerCapture(e.pointerId);drag={x:e.clientX,y:e.clientY,pan:e.shiftKey||e.button!==0};element.style.cursor='grabbing';};
  ...
  const up=()=>{drag=null;element.style.cursor='grab';};
 ...
 return <section className="atlas-workspace">
  ...
  <p>왼쪽 드래그: 회전<br/>Shift + 드래그: 이동<br/>휠: 확대·축소</p>
